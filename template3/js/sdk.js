try {
            ...
            with (this) {
                ...
                __d("json3", [], (function aa(ba, ca, da, ea, fa, a) {
                    ...
                    (function () {
                        var ha;
                        (function () {
                            var ia = typeof ha === "function" && ha.amd, d = {"function": true, object: true},
                                e = d[typeof b] && b && !b.nodeType && b, f = d[typeof window] && window || this,
                            ...
                            function h(k, a) {
                                k || (k = f.Object());
                                a || (a = f.Object());
                                var la = k.Number || f.Number, ma = k.String || f.String, na = k.Object || f.Object,
                                    l = k.Date || f.Date, oa = k.SyntaxError || f.SyntaxError,
                                    pa = k.TypeError || f.TypeError, qa = k.Math || f.Math, i = k.JSON || f.JSON;
                                if (typeof i == "object" && i) {
                                    a.stringify = i.stringify;
                                    a.parse = i.parse
                                }
                                var ra = na.prototype, m = ra.toString, n, o, p, q = new l(-3509827334573292);
                                try {
                                ...
                                function s(H) {
                                    if (s[H] !== p) return s[H];
                                    var I;
                                    if (H == "bug-string-char-index") I = "a"[0] != "a"; else if (H == "json") I = s("json-stringify") && s("json-parse"); else {
                                        var J, K = '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}';
                                        if (H == "json-stringify") {
                                            var L = a.stringify, M = typeof L == "function" && q;
                                            if (M) {
                                                (J = function () {
                                                    return 1
                                                }).toJSON = J;
                                                try {
                                                    M = L(0) === "0" && L(new la()) === "0" && L(new ma()) == '""' && L(m) === p && L(p) === p && L() === p && L(J) === "1" && L([J]) == "[1]" && L([p]) == "[null]" && L(null) == "null" && L([p, m, null]) == "[null,null,null]" && L({a: [J, true, false, null, "\0\b\n\f\r\t"]}) == K && L(null, J) === "1" && L([1, 2], null, 1) == "[\n 1,\n 2\n]" && L(new l(-864e13)) == '"-271821-04-20T00:00:00.000Z"' && L(new l(864e13)) == '"+275760-09-13T00:00:00.000Z"' && L(new l(-621987552e5)) == '"-000001-01-01T00:00:00.000Z"' && L(new l(-1)) == '"1969-12-31T23:59:59.999Z"'
                                                } catch (r) {
                                                    M = false
                                                }
                                            }
                                ...
                                if (!s("json")) {
                                    var t = "[object Function]", sa = "[object Date]", u = "[object Number]",
                                        v = "[object String]", w = "[object Array]", ta = "[object Boolean]",
                                    ...
                                    if (!(n = ra.hasOwnProperty)) n = function (H) {
                                        var I = {}, J;
                                        if ((I.__proto__ = null, I.__proto__ = {toString: 1}, I).toString != m) n = function (H) {
                                            var K = this.__proto__, L = H in (this.__proto__ = null, this);
                                            this.__proto__ = K;
                                            return L
                                        }; else {
                                            J = I.constructor;
                                    ...
                                    o = function (H, I) {
                                        ...
                                        L = new K();
                                        for (M in L) if (n.call(L, M)) J++;
                                        K = L = null;
                                        if (!J) {
                                            L = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"];
                                            o = function (H, I) {
                                                var N = m.call(H) == t, M, O,
                                                    P = !N && typeof H.constructor != "function" && d[typeof H.hasOwnProperty] && H.hasOwnProperty || n;
                                                for (M in H) if (!(N && M == "prototype") && P.call(H, M)) I(M);
                                                for (O = L.length; M = L[--O]; P.call(H, M) && I(M)) ;
                                            }
                                        } else if (J == 2) o = function (H, I) {
                                            var L = {}, N = m.call(H) == t, M;
                                            for (M in H) if (!(N && M == "prototype") && !n.call(L, M) && (L[M] = 1) && n.call(H, M)) I(M)
                                        }; else o = function (H, I) {
                                            var N = m.call(H) == t, M, O;
                                            for (M in H) if (!(N && M == "prototype") && n.call(H, M) && !(O = M === "constructor")) I(M);
                                    ...
                                    if (!s("json-stringify")) {
                                        var va = {
                                            ...
                                            13: "\\r",
                                            9: "\\t"
                                        }, wa = "000000", A = function (H, I) {
                                            return (wa + (I || 0)).slice(-H)
                                        }, xa = "\\u00", ya = function (H) {
                                            var I = '"', J = 0, K = H.length, L = !x || K > 10,
                                                M = L && (x ? H.split("") : H);
                                            for (; J < K; J++) {
                                            ...
                                            if (typeof O == "object" && O) {
                                                P = m.call(O);
                                                if (P == sa && !n.call(O, "toJSON")) if (O > -1 / 0 && O < 1 / 0) {
                                                    if (z) {
                                                        S = y(O / 864e5);
                                                ...
                                                } else O = null; else if (typeof O.toJSON == "function" && (P != u && P != v && P != w || n.call(O, "toJSON"))) O = O.toJSON(H)
                                            }
                                            if (J) O = J.call(I, H, O);
                                            if (O === null) return "null";
                                            P = m.call(O);
                                            if (P == ta) return "" + O; else if (P == u) return O > -1 / 0 && O < 1 / 0 ? "" + O : "null"; else if (P == v) return ya("" + O);
                                            if (typeof O == "object") {
                                                for ($ = N.length; $--;) if (N[$] === O) throw pa();
                                                N.push(O);
                                                X = [];
                                                Ea = M;
                                                M += L;
                                        ...
                                        a.stringify = function (H, I, J) {
                                            var K, L, M, N;
                                            if (d[typeof I] && I) if ((N = m.call(I)) == t) L = I; else if (N == w) {
                                                M = {};
                                                for (var O = 0, P = I.length, Q; O < P; Q = I[O++], (N = m.call(Q), N == v || N == u) && (M[Q] = 1)) ;
                                            }
                                            if (J) if ((N = m.call(J)) == u) {
                                                if ((J -= J % 1) > 0) for (K = "", J > 10 && (J = 10); K.length < J; K += " ") ;
                                            } else if (N == v) K = J.length <= 10 ? J : J.slice(0, 10);
                                            return B("", (Q = {}, Q[""] = H, Q), L, M, K, "", [])
                                        }
                                    }
                                    if (!s("json-parse")) {
                                        var za = ma.fromCharCode, Aa = {
                                            92: "\\",
                                            34: '"',
                                            47: "/",
                                            98: "\b",
                                            ...
                                            var K = Ca(H, I, J);
                                            if (K === p) delete H[I]; else H[I] = K
                                        }, Ca = function (H, I, J) {
                                            var K = H[I], L;
                                            if (typeof K == "object" && K) if (m.call(K) == w) for (L = K.length; L--;) Ba(K, L, J); else o(K, function (I) {
                                                Ba(K, I, J)
                                            });
                                            return J.call(H, I, K)
                                        };
                            ...
                            if (e && !ia) h(f, e); else {
                                var i = f.JSON, ja = f.JSON3, ka = false, j = h(f, f.JSON3 = {
                                    noConflict: function () {
                                        if (!ka) {
                                            ka = true;
                                            f.JSON = i;
                                ...
                                f.JSON = {parse: j.parse, stringify: j.stringify}
                            }
                        }).call(this)
                    })();
                    var ga = c.exports;
                ...
                __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "3435907"});
                __d("JSSDKConfig", [], {
                    "bustCache": true,
                ...
                __d("flattenObject", [], (function a(b, c, d, e, f, g) {
                    function h(i) {
                        ...
                        for (var k in i) if (Object.prototype.hasOwnProperty.call(i, k)) {
                            var l = i[k];
                            if (null === l || undefined === l) continue; else if (typeof l == "string") j[k] = l; else j[k] = ES("JSON", "stringify", false, l)
                        }
                        return j
                    }
                ...
                __d("CORSRequest", ["wrapFunction", "QueryString", "errorCode", "sdk.safelyParseResponse"], (function a(b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function m(o, p, q, r) {
                        ...
                        t.onerror = function (u) {
                            if (u.responseText) r(k(u.responseText)); else r({
                                error: {
                                    code: 1,
                ...
                __d("ApiClient", ["ApiBatcher", "ApiClientUtils", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "ApiClientConfig"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
                    var t, u, v, w = n.MAX_QUERYSTRING_LENGTH, x = {
                        ...
                        stream_get: true,
                        users_getinfo: true
                    }, y = ["jsonp", "cors", "flash"], z = 0, A = [], B = 0, C = 0, D;
                    ...
                    function E(L, M, N, O) {
                        ...
                        N.pretty = N.pretty || 0;
                        N = m(N);
                        var Q = {jsonp: n, cors: k, flash: l}, R = {}, S = N.access_token || t;
                        ...
                        for (var V = 0; V < U.length; V++) {
                            var W = Q[U[V]], X = ES("Object", "assign", false, {}, N);
                            if (W.execute(L, M, X, O)) return
                        }
                        O({error: {type: "no-transport", message: "Could not find a usable transport for request"}})
                    }
                    ...
                    function G() {
                        for (var L = arguments.length, M = Array(L), N = 0; N < L; N++) M[N] = arguments[N];
                        var O = i.parseCallDataFromArgs(M), P = O.uri, Q = O.callback, R = O.params, S = R.method;
                        if (K(P, S)) S = "post";
                    ...
                    function I(L, M) {
                        ...
                        L.api_key = u;
                        var O = N in x ? "api_read" : "api", P = r.resolve(O) + "/restserver.php", Q = C++,
                            R = ES(F, "bind", true, null, M, "/restserver.php", "get", L, ES("Date", "now", false), Q);
                        E(P, "get", L, R)
                    }
                    ...
                    var J = ES("Object", "assign", false, new p(), {
                        setAccessToken: function L(M) {
                            ...
                            return A.length
                        }, rest: I, graph: G, scheduleBatchCall: H, prepareBatchParams: h.prepareBatchParams
                    });
                ...
                __d("MobileDevSettingsKey", [], (function a(b, c, d, e, f, g) {
                    f.exports = Object.freeze({SETTING_SCREEN_DIMENSIONS: "MDEV_SCREEN_DIMENSIONS"})
                }), null);
                __d("FBPixelEndpoint", ["FBEventsParamList", "FBEventsUtils", "MobileDevSettingsKey"], (function a(b, c, d, e, f, g, h, i, j) {
                    "use strict";
                    var k = "https://www.facebook.com/tr/", l = location.href, m = window.top !== window,
                        n = document.referrer;
                    ...
                    function o(t, u, v, w) {
                        ...
                        x.append("rl", n);
                        x.append("if", m);
                        x.append("ts", new Date().valueOf());
                        x.append("cd", v);
                        x.append(j.SETTING_SCREEN_DIMENSIONS, window.screen.width + "x" + window.screen.height);
                        for (var y in w) x.append(y, w[y]);
                        return x
                    }

                    function p(t, u, v, w) {
                        var x = o(t, u, v, w), y = x.toQueryString();
                        if (2048 > (k + "?" + y).length) q(k, y); else r(k, x)
                    }
                    ...
                    function r(t, u) {
                        var v = "fb" + Math.random().toString().replace(".", ""), w = document.createElement("form");
                        w.method = "post";
                        w.action = t;
                        w.target = v;
                        w.acceptCharset = "utf-8";
                        w.style.display = "none";
                        var x = !!(window.attachEvent && !window.addEventListener),
                            y = x ? '<iframe name="' + v + '">' : "iframe", z = document.createElement(y);
                        z.src = "javascript:false";
                        z.id = v;
                        z.name = v;
                        w.appendChild(z);
                        i.listenOnce(z, "load", function () {
                            u.each(function (v, A) {
                ...
                __d("sdk.Extensions", ["sdk.UA", "JSONRPC", "Queue"], (function a(b, c, d, e, f, g, h, i, j) {
                    "use strict";
                    var k = new j(), l = new i(function (o) {
                        k.enqueue(o)
                    }), m = new j();
                    m.start(function (o) {
                        l.read(o)
                    ...
                    if (n) {
                        ...
                        if (h.android()) n.initializeCallbackHandler(ES("JSON", "stringify", false, {name: "_FBBrowserCallbackHandler"}));
                        k.start(function (o) {
                            if (n) n.jsonRPC(o)
                        })
                    }
                ...
                __d("sdk.XFBML.CustomerChat", ["sdk.Content", "sdk.DialogUtils", "sdk.DOM", "sdk.Event", "IframePlugin", "QueryString", "sdk.XD", "sdk.createIframe"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    var p = l.extend({
                        constructor: function q(r, s, t, u) {
                            j.setStyle(r, "overflowX", "hidden");
                            j.setStyle(r, "width", "0");
                            j.setStyle(r, "height", "0");
                            j.setStyle(r, "display", "inherit");
                            this.parent(r, s, t, u);
                            ...
                            this.subscribe("xd.liveChatPluginPrepareDesktopAnchorIframe", ES(function (v) {
                                if (this._iframe) ES("Object", "assign", false, this._iframe.style, {
                                    borderRadius: "9pt",
                                    bottom: "72pt",
                                ...
                                if (ES("JSON", "parse", false, v.chatStarted)) ES("Object", "assign", false, this._iframe.style, {height: "360pt"}); else ES("Object", "assign", false, this._iframe.style, {height: "104.25pt"})
                            }, "bind", true, this));
                            ...
                            this.subscribe("xd.liveChatPluginExpandMobileDialogIframe", ES(function (v) {
                                this._iframe && j.setStyle(this._iframe, "border-radius", "0");
                                this._iframe && j.setStyle(this._iframe, "height", "100%");
                                this._iframe && j.setStyle(this._iframe, "right", "0");
                                this._iframe && j.setStyle(this._iframe, "top", "0");
                                this._iframe && j.setStyle(this._iframe, "width", "100%");
                            ...
                            this.subscribe("xd.liveChatPluginShowDialogIframe", ES(function (v) {
                                ...
                                if (ES("JSON", "parse", false, v.isMobile) && ES("JSON", "parse", false, v.chatStarted)) this.setParentDocumentPositionFixed()
                            }, "bind", true, this));
                            this.subscribe("xd.liveChatPluginHideDialogIframe", ES(function (v) {
                                if (ES("JSON", "parse", false, v.isMobile) && ES("JSON", "parse", false, v.chatStarted)) this.resetParentDocumentPosition();
                            ...
                            var t = "#" + m.encode({forIframe: r}), u = i.setupNewDialog();
                            o({
                        ...
                        }, setParentDocumentPositionFixed: function q() {
                        ...
                        }, resetParentDocumentPosition: function q() {
                            ...
                            return {minimized: "bool", page_id: "string"}
                        }
                    });
                    f.exports = p
                }), null);
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"3435907","namespace":"FB","message":"' + e.message + '"}}');
}